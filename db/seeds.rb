...
additional_tests = [
  users[1].author_tests.create!(title: 'Famous Landmarks', level: 2, category: categories[0]),
  users[2].author_tests.create!(title: 'World Wars', level: 3, category: categories[1])
]
